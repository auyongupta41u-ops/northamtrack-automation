...
/**
 * ════════════════════════════════════════════════════════════════════════════════
 * NORTHAMTRACK FINAL SCRAPER
 * 
 * Corrected scraper that uses only existing Supabase columns
...
console.log('════════════════════════════════════════════════════════════════');
console.log('  NORTHAMTRACK FINAL SCRAPER');
...
async function scrapeSEC() {
    ...
    try {
        ...
        for (let i = 0; i < Math.min(feed.items.length, 25); i++) {
            ...
            // Create summary from content/description
            const fullText = item.content || item.summary || item.description || '';
            const summary = fullText.substring(0, 300) + (fullText.length > 300 ? '...' : '');
